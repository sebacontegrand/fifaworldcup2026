...
const CONNECTION_WEIGHT = 0.25
const PREDICTION_WEIGHT = 0.35
const POOL_WEIGHT = 0.40
...
export async function GET() {
  ...
  const leaderboard = users
    .map((user) => {
      ...
      const overallScore = connectionSkill * CONNECTION_WEIGHT + predictionSkill * PREDICTION_WEIGHT + poolSkill * POOL_WEIGHT + adjustment
